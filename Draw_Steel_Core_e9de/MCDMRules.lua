...
GameSystem.SavingThrowRollName = "Resistance Roll"
...
GameSystem.RegisterAbilityCategorization("Basic Attack")
GameSystem.RegisterAbilityCategorization("Signature Ability")
GameSystem.RegisterAbilityCategorization("Heroic Ability")
GameSystem.RegisterAbilityCategorization("Ability")
GameSystem.RegisterAbilityCategorization("Trigger")
GameSystem.RegisterAbilityCategorization("Skill")
GameSystem.RegisterAbilityCategorization("Malice")
GameSystem.RegisterAbilityCategorization("Hidden")
...
--default damage type is 'normal' damage.
ActivatedAbilityBehavior.damageType = "normal"
...
GameSystem.OnEndCastActivatedAbility = function(casterToken, ability, options)
	if ability.categorization == "Signature Ability" and (ability:HasKeyword("Area") or ability:HasKeyword("Strike")) then
		casterToken.properties:TriggerEvent("castsignature", {ability = ability, cast = options.symbols.cast})
	end
end
