	...
	local args = {
		...
		create = function(element)
			...
			featureOptions[#featureOptions+1] = {
                ...
                hidden = function() return clipboardItem == nil or (clipboardItem.typeName ~= 'CharacterFeature' and clipboardItem.typeName ~= 'CharacterFeatureChoice' and clipboardItem.typeName ~= 'CharacterSkillChoice') end,
			}
