...
local function increment_squad_name(squad_name)
    ...
    if sheetParent ~= nil and sheetParent.sheet == nil then
        ...
        local panel = gui.Button{
            ...
            press = function(element)
                ...
                for i=1,100 do
                    newName = increment_squad_name(newName)
            ...
            think = function(element)
                ...
                if minionCount < 2 or minionCount >= squad.liveMinions then
                    sheetParent:Destroy()
                    return
                end
        ...
        local m_fill = gui.Panel{
            ...
            think = function(element)
                ...
                if dmhub.isDM and squad.damage_taken < squad.health_single then
                    ...
                    if matchingMinions > 1 and matchingMinions < squad.liveMinions then
                        ...
                        local link = gui.Panel{
                            ...
                            think = function(element)
                                if tok.valid then
                                    ...
                                    local dir = core.Vector2(m_currentPos.x - tokenPos.x, m_currentPos.y - tokenPos.y).unit
                                    ...
                                    local dx = tokEdgePos.x - m_currentPos.x
                                    local dy = tokEdgePos.y - m_currentPos.y
                                    local angle = math.atan2(dy, dx)
                                    element.selfStyle.rotate = math.deg(angle) + 90
                                    element.selfStyle.height = math.sqrt(dx*dx + dy*dy) * g_tileSize
                                    element.x = (tokEdgePos.x + m_currentPos.x) * g_tileSize / 2
                                    element.y = -(tokEdgePos.y + m_currentPos.y) * g_tileSize / 2
            ...
            gui.Panel{
                ...
                gui.Panel{
                    ...
                    think = function(element)
                        ...
                        if tokenHovered ~= nil and tokenHovered.properties:try_get("_tmp_minionSquad") == squad then
                            highlight = true
                        end
